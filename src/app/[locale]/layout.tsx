...
export const metadata: Metadata = {
  ...
  description:
    "Kontraktor spesialis instalasi pipa gas industri, sistem hydrant, pekerjaan mekanikal (boiler/chiller), pengadaan material gas, instalasi gas dapur dan jasa interior komersial.",
  keywords: [
    ...
    "Putu Marta Mandiri",
    "instalasi gas dapur",
    "instalasi gas kitchen",
    "instalasi gas industri",
    "pengadaan material gas industri",
    "pengadaan material gas dapur",
    "jasa instalasi gas industri Jakarta / Indonesia",
    "kontraktor spesialis pipa gas gedung",
    "jasa pasang instalasi LPG & LNG komersial",
    "sistem keselamatan pipa gas industri",
    "pemasangan instalasi gas central restoran / hotel",
    "perawatan & audit kebocoran gas industri",
    "suplier & perakitan tabung manifold gas",
    "instalasi pipa gas rumah",
    "harga jasa instalasi pipa gas",
    "instalasi pipa gas Ipg 50 kg",
    "instalasi pipa gas central",
  ],
